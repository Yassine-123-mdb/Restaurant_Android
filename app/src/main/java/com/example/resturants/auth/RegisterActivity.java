...
import android.content.Intent; // Import pour gérer les Intentions
...
import com.example.resturants.auth.LoginActivity;
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            finish(); // Terminer cette activité pour qu'elle ne reste pas dans la pile
                        } else {
